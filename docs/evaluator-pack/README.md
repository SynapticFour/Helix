...
Full contract (spec vs fixtures vs optional vs current-runner extras): [../EXTERNAL_TARGET_CONTRACT.md](../EXTERNAL_TARGET_CONTRACT.md). Product picture: [../HELIX_PRODUCT.md](../HELIX_PRODUCT.md). Versioned DRS 1.4.0 operator path (`helix inspect`): [../OPERATOR_VERIFY.md](../OPERATOR_VERIFY.md).
